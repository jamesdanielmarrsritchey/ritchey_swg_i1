#!/bin/bash
# This script is experimental. It restores configuration, content input files, and uploads. Run it from this directory only.
set -euo pipefail
...
RESTORE_DIR3="$PROJECT_ROOT/Source/Uploads"

echo "Backup source: $BACKUP_DIR"
echo "Restore 1:     $RESTORE_DIR1"
echo "Restore 2:     $RESTORE_DIR2"
echo "Restore 3:     $RESTORE_DIR3"
...
BACKUP_SOURCE3="$BACKUP_DIR/Uploads"
...
if [ ! -d "$BACKUP_SOURCE3" ]; then
    echo "ERROR: Backup source directory 3 does not exist."
    exit 1
fi
...
# Restore backup directory 3
echo "Restoring: $BACKUP_SOURCE3"
rsync -av "$BACKUP_SOURCE3/" "$RESTORE_DIR3/"
