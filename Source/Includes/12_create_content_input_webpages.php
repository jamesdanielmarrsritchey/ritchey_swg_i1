...
HEREDOC;	
	...
	if (is_int($var_114285e6616f4a028017a2c7cb9fd3cd_configuration_information_arr['css_id']) === TRUE){
		if (file_exists("{$var_26d3c836_location_str}/Source/Content Inputs/Assets/{$var_26d3c836_item_name_str} {$var_114285e6616f4a028017a2c7cb9fd3cd_configuration_information_arr['css_id']} CSS.conf") === TRUE){
			$var_c836c568_item_css2_str = trim(ritchey_get_line_by_prefix_i1_v3("{$var_26d3c836_location_str}/Source/Content Inputs/Assets/{$var_26d3c836_item_name_str} {$var_114285e6616f4a028017a2c7cb9fd3cd_configuration_information_arr['css_id']} CSS.conf", 'Destination: ', FALSE, FALSE, TRUE));
	...
	if (is_int($var_114285e6616f4a028017a2c7cb9fd3cd_configuration_information_arr['css_id']) === TRUE){
		if (file_exists("{$var_26d3c836_location_str}/Source/Content Inputs/Assets/{$var_26d3c836_item_type_str}s {$var_114285e6616f4a028017a2c7cb9fd3cd_configuration_information_arr['css_id']} CSS.conf") === TRUE){
			$var_c836c568_item_type_css2_str = trim(ritchey_get_line_by_prefix_i1_v3("{$var_26d3c836_location_str}/Source/Content Inputs/Assets/{$var_26d3c836_item_type_str}s {$var_114285e6616f4a028017a2c7cb9fd3cd_configuration_information_arr['css_id']} CSS.conf", 'Destination: ', FALSE, FALSE, TRUE));
	...
	if ($var_26d3c836_item_name_str === 'Statistics' || $var_26d3c836_item_name_str === 'Navigation' || $var_26d3c836_item_name_str === 'Landing' || $var_26d3c836_item_name_str === '404' || $var_26d3c836_item_name_str === 'Legal' || $var_26d3c836_item_name_str === 'About' || $var_26d3c836_item_name_str === 'Supported Systems' || $var_26d3c836_item_name_str === 'Brute Force' || $var_26d3c836_item_name_str === 'Search'){
