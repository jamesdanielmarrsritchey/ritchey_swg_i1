...
foreach ($var_114285e6616f4a028017a2c7cb9fd3cd_configuration_information_arr as $var_da1cdfc8_key_uns => $var_da1cdfc8_item_str){
	if ($var_da1cdfc8_key_uns == 'url'){
		...
		$var_da1cdfc8_global_variables_arr[] = "\t" . "var_da1cdfc8_{$var_da1cdfc8_key_uns}_gstr='{$var_da1cdfc8_item_str}';";
	} else if ($var_da1cdfc8_key_uns == 'items_per_page_limit'){
...
#### Determine databases size
require_once $var_da1cdfc8_location_str . '/Source/Dependencies/ritchey_get_lines_by_prefix_i1_v1/ritchey_get_lines_by_prefix_i1_v1.php';
$var_da1cdfc8_value_str = ritchey_get_lines_by_prefix_i1_v1("{$var_da1cdfc8_location_str}/Source/Configuration Files/Database Size.autoconf", 'Content:', '"', 1, TRUE);
$var_da1cdfc8_global_variables_arr[] = "\t" . "var_da1cdfc8_database_size_gnum={$var_da1cdfc8_value_str};";
