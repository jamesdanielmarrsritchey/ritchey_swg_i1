<?php
if (function_exists('ritchey_rmlv4_markup_to_html_v2') === FALSE){
function ritchey_rmlv4_markup_to_html_v2($source_string, $preserve_empty_lines = NULL, $display_errors = NULL){
	$errors = array();
	...
	if (@empty($errors) === TRUE){
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_page_outter' id='mu_page_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_page_inner' id='mu_page_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_page_meta' id='mu_page_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ <span class='mu_page_number'>{$number}</span>
\\\\ </div>
\\\\ <div class='mu_page_content' id='mu_page_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_section_0_outter' id='mu_section_0_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_section_0_inner' id='mu_section_0_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_section_0_meta' id='mu_section_0_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ </div>
\\\\ <div class='mu_section_0_content' id='mu_section_0_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_section_1_outter' id='mu_section_1_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_section_1_inner' id='mu_section_1_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_section_1_meta' id='mu_section_1_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ </div>
\\\\ <div class='mu_section_1_content' id='mu_section_1_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_section_2_outter' id='mu_section_2_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_section_2_inner' id='mu_section_2_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_section_2_meta' id='mu_section_2_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ </div>
\\\\ <div class='mu_section_2_content' id='mu_section_2_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_section_3_outter' id='mu_section_3_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_section_3_inner' id='mu_section_3_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_section_3_meta' id='mu_section_3_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ </div>
\\\\ <div class='mu_section_3_content' id='mu_section_3_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_section_4_outter' id='mu_section_4_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_section_4_inner' id='mu_section_4_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_section_4_meta' id='mu_section_4_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ </div>
\\\\ <div class='mu_section_4_content' id='mu_section_4_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_section_5_outter' id='mu_section_5_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_section_5_inner' id='mu_section_5_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_section_5_meta' id='mu_section_5_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ </div>
\\\\ <div class='mu_section_5_content' id='mu_section_5_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_section_6_outter' id='mu_section_6_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_section_6_inner' id='mu_section_6_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_section_6_meta' id='mu_section_6_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ </div>
\\\\ <div class='mu_section_6_content' id='mu_section_6_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_blockquote_outter' id='mu_blockquote_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_blockquote_inner' id='mu_blockquote_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_blockquote_meta' id='mu_blockquote_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ </div>
\\\\ <div class='mu_blockquote_content' id='mu_blockquote_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_blockmessage_outter' id='mu_blockmessage_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_blockmessage_inner' id='mu_blockmessage_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_blockmessage_meta' id='mu_blockmessage_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ </div>
\\\\ <div class='mu_blockmessage_content' id='mu_blockmessage_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_blockstyled_outter' id='mu_blockstyled_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_blockstyled_inner' id='mu_blockstyled_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_blockstyled_meta' id='mu_blockstyled_{$number}_meta' data-uuid='{$uuid}_3'>
\\\\ </div>
\\\\ <div class='mu_blockstyled_content' id='mu_blockstyled_{$number}_content' data-uuid='{$uuid}_4'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_dotlist_outter' id='mu_dotlist_{$number}_outter' data-uuid='{$uuid}_1'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>		
HTML2;
...
HTML2;
			...
			// Add level
				...
				$value = "\\\\e001 <span class='mu_dot_{$level}'>&bull;</span> " . preg_replace('/^\s*-\s*/', '', $value);
			}
		}
		unset($value);
		$data = implode(PHP_EOL, $data);
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_numberedlist_outter' id='mu_numberedlist_{$number}_outter' data-uuid='{$uuid}_1'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>		
HTML2;
		...
		foreach ($data as &$value){
			$html_1 = <<<HTML1
\\\\ <div class='mu_numberedlist_entry'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>		
HTML2;
			...
			// Add level
				...
				$value = "\\\\e001 <span class='mu_bullnum_{$level}'>{$bullet_number}</span> " . preg_replace('/^\s*\d+\.\s+/', '', $value);
			}
		}
		unset($value);
		$data = implode(PHP_EOL, $data);
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <br class='mu_br_content' id='mu_br_{$number}_content' data-uuid='{$uuid}_1'>
HTML1;
			// When encountering start, replace with start.
			if ($value === '// Empty Line Entry Start'){
				$value = $html_1;
		...
		foreach ($data as &$value){
			$uuid = hash('md5', $value);
			$html_1 = <<<HTML1
\\\\ <div class='mu_h1_outter' id='mu_h1_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_h1_inner' id='mu_h1_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <h1 class='mu_h1_content' id='mu_h1_{$number}_content' data-uuid='{$uuid}_3'>
HTML1;
			$html_2 = <<<HTML2
</h1>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			$uuid = hash('md5', $value);
			$html_1 = <<<HTML1
\\\\ <div class='mu_h2_outter' id='mu_h2_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_h2_inner' id='mu_h2_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <h2 class='mu_h2_content' id='mu_h2_{$number}_content' data-uuid='{$uuid}_3'>
HTML1;
			$html_2 = <<<HTML2
</h2>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			$uuid = hash('md5', $value);
			$html_1 = <<<HTML1
\\\\ <div class='mu_h3_outter' id='mu_h3_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_h3_inner' id='mu_h3_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <h3 class='mu_h3_content' id='mu_h3_{$number}_content' data-uuid='{$uuid}_3'>
HTML1;
			$html_2 = <<<HTML2
</h3>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			$uuid = hash('md5', $value);
			$html_1 = <<<HTML1
\\\\ <div class='mu_h4_outter' id='mu_h4_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_h4_inner' id='mu_h4_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <h4 class='mu_h4_content' id='mu_h4_{$number}_content' data-uuid='{$uuid}_3'>
HTML1;
			$html_2 = <<<HTML2
</h4>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			$uuid = hash('md5', $value);
			$html_1 = <<<HTML1
\\\\ <div class='mu_h5_outter' id='mu_h5_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_h5_inner' id='mu_h5_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <h5 class='mu_h5_content' id='mu_h5_{$number}_content' data-uuid='{$uuid}_3'>
HTML1;
			$html_2 = <<<HTML2
</h5>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			$uuid = hash('md5', $value);
			$html_1 = <<<HTML1
\\\\ <div class='mu_h6_outter' id='mu_h6_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_h6_inner' id='mu_h6_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <h6 class='mu_h6_content' id='mu_h6_{$number}_content' data-uuid='{$uuid}_3'>
HTML1;
			$html_2 = <<<HTML2
</h6>
\\\\ </div>
...
HTML2;
		...
		foreach ($data as &$value){
			...
			$html_1 = <<<HTML1
\\\\ <div class='mu_hr_outter' id='mu_hr_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_hr_inner' id='mu_hr_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <hr class='mu_hr_content' id='mu_hr_{$number}_content' data-uuid='{$uuid}_3'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>	
...
HTML2;
		...
		function regex_callback_for_labels_v1($matches) {
			...
			$html_1 = <<<HTML1
<span class='mu_label_outter' data-uuid='{$uuid}_1'><span class='mu_label_text' data-uuid='{$uuid}_2'>
HTML1;
			$html_2 = <<<HTML2
</span><span class='mu_label_end' data-uuid='{$uuid}_3'>:</span></span>
HTML2;		
		...
		foreach ($data as &$value){
			$uuid = hash('md5', "{$number}{$value}");
			$html_1 = <<<HTML1
\\\\ <div class='mu_tags_outter' id='mu_tags_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_tags_inner' id='mu_tags_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_tags_content' id='mu_tags_{$number}_content' data-uuid='{$uuid}_3'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
			...
			// When encountering tags start, replace with start, and end
				...
				foreach ($value as &$value_2){
					$value_2 = "\\\\ <div class='mu_tag_entry'>{$value_2}</div>";
				}
				unset($value_2);
		...
		foreach ($data as &$value){
			$uuid = hash('md5', "{$number}{$value}");
			$html_1 = <<<HTML1
\\\\ <div class='mu_flatlist_outter' id='mu_flatlist_{$number}_outter' data-uuid='{$uuid}_1'>
\\\\ <div class='mu_flatlist_inner' id='mu_flatlist_{$number}_inner' data-uuid='{$uuid}_2'>
\\\\ <div class='mu_flatlist_content' id='mu_flatlist_{$number}_content' data-uuid='{$uuid}_3'>
HTML1;
			$html_2 = <<<HTML2
\\\\ </div>
\\\\ </div>
...
HTML2;
			...
			// When encountering start, replace with start, and end
				...
				foreach ($value as &$value_2){
					$value_2 = "\\\\ <div class='mu_flatlist_entry'>{$value_2}</div>";
				}
				unset($value_2);
				$value = implode(PHP_EOL, $value);
				// Add list element
		...
		function regex_callback_for_special_comments_v1($matches) {
			$uuid = hash('md5', $matches[0]);
			$html_1 = <<<HTML1
<span class='mu_special_comment_outter' data-uuid='{$uuid}_1'><span class='mu_special_comment_text_text' data-uuid='{$uuid}_2'>
HTML1;
			$html_2 = <<<HTML2
</span></span>
HTML2;		
		...
		function regex_callback_for_hyperlinks_v1($matches) {
			$uuid = hash('md5', $matches[0]);
			$html_1 = <<<HTML1
<span class='mu_hyperlink_outter' data-uuid='{$uuid}_1'><span class='mu_hyperlink_inner' data-uuid='{$uuid}_2'><a class='mu_hyperlink_content' data-uuid='{$uuid}_3'
HTML1;
			$html_2 = <<<HTML2
</a></span></span>
HTML2;		
		...
		function regex_callback_for_styledtext_v1($matches) {
			$uuid = hash('md5', $matches[0]);
			$html_1 = <<<HTML1
<span class='mu_styledtext_outter' data-uuid='{$uuid}_1'><span class='mu_styledtext_inner' data-uuid='{$uuid}_2'>
HTML1;
			$html_2 = <<<HTML2
</span></span>
HTML2;
			$return = $html_1 . "<span class='mu_" . strtolower($matches[2]) . "'>" . $matches[1] . "</span>" . $html_2;
    		return $return;
		}
		}
		foreach ($data as &$value){
		...
		function regex_callback_for_images_v1($matches) {
			$uuid = hash('md5', $matches[0]);
			$html_1 = <<<HTML1
<div class='mu_image_outter' data-uuid='{$uuid}_1'><div class='mu_image_inner' data-uuid='{$uuid}_2'><img class='mu_image_content' data-uuid='{$uuid}_3' src='
HTML1;
			$html_2 = <<<HTML2
' alt="image"></div></div>
HTML2;
		...
		foreach ($data as &$value){
			...
			// When encountering, replace.
				...
				$value = "<p id='mu_p_{$number}_content' data-uuid='{$uuid}_1'>{$value}</p>";
				$number++;
			}
		}
		unset($value);
	...
	if ($display_errors === TRUE){
		if (@empty($errors) === FALSE){
			...
			if (function_exists('ritchey_rmlv4_markup_to_html_v2_format_error') === FALSE){
				function ritchey_rmlv4_markup_to_html_v2_format_error($errno, $errstr){
					echo $errstr;
				}
			}
			set_error_handler("ritchey_rmlv4_markup_to_html_v2_format_error");
