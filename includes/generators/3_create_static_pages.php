...
// Description: Imports the information stored in "/content_files/pages/", and uses it to generate those files in the public directory.
# Content
## Prep
$n = 1;
...
## Task
$script_id = '';
### Create a list of static pages, and for each, import the data, and generate the file.
...
foreach ($files as &$item){
	...
	$page_name = ritchey_get_line_by_prefix_i1_v3($item, 'Name: ', FALSE, FALSE, TRUE);
	$content_1 = <<<HEREDOC
...
<link rel="stylesheet" href="{$global_configuration_info['address']}/assets/localized/{$style_sheet}.css">
HEREDOC;
	} else {
