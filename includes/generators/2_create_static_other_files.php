<?php
# Meta
// Name: Create Static Other Files
// Description: Imports the information stored in "/content_files/static_other_files/", and uses it to generate those files in the public directory.
# Content
## Prep
$n = 1;
...
$files = ritchey_list_files_with_prefix_postfix_i1_v1("{$location}/content_files/static_other_files", NULL, '.txt', TRUE);
